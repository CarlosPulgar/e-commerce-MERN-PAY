      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-2'>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
          ...
          <div>
            ...
            <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type="number" placeholder='10000' required />
          </div>
        </div>
        <div>
        ...
        <button type='submit' className='mt-3 bg-black text-white w-[120px] h-[50px]   rounded-full '>ADD</button>
      </form>
    </div>
  )
}

...
const MyProfile = () => {
    ...
    return userData && (
        ...
        <div className="text-2xl">
         <Title text1={"MY"} text2={" PROFILE"}></Title>
        </div>
        {
            isEdit
            ? <label htmlFor='image' >
        ...
        <div>
          ...
          <div className='mt-10'>
            ...
            {
              isEdit
              ? <button className='border border-primary px-8 py-2 rounded-full mb-3 hover:bg-primary hover:text-white transition-all' onClick={updateUserProfileData}>save information</button>
              : <button className='border border-primary px-8 py-2 rounded-full mb-3 hover:bg-primary hover:text-white transition-all' onClick={()=> setIsEdit(true)}>Edit</button>
            }
          </div>
        </div>
